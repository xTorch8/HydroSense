...
const Cards = (props: CardsType) => {
	return (
		<div className="bg-biru1 text-biru5 w-full my-2 md:my-4 rounded-2xl border-solid border-biru5 border-4 block mx-auto hover:border-black hover:bg-biru5 hover:text-white group">
