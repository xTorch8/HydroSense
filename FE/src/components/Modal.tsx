...
const Modal = (props: ModalType) => {
	return (
		<div className="bg-darkblue w-[50rem] h-[25rem] block mx-auto absolute top-0 bottom-0 left-0 right-0 m-auto border-2 border-color4 z-10">
			<div className="bg-navy flex flex-row justify-between p-4">
				<h1 className="text-white"> HydroSense </h1>
				<p className="text-white" onClick={props.onClose}>
					X
				</p>
			</div>
			<div className="bg-darkblue px-4 pt-4">
				<div>
					...
					<Button text="Confirm" isPrimary={false} style="tertiary" />
				</div>
			</div>
		</div>
	);
